...
\newcommand{\mypagestyle}{
	...
	\rhead{\thepage}
	\lhead{\leftmark}
	\fancyfoot[CE,CO]{\textit{Ef{}fective Caching in Online Video Platforms}}
...
\newcommand*{\titleGM}{\begingroup % Create the command for including the title page in the document
	...
	\hbox{ % Horizontal box
		...
		\parbox[b]{0.75\textwidth}{ % Paragraph box which restricts text to less than the width of the page
			...
			{\large \textit{some subtitles}}\\[4\baselineskip] % Tagline or further description
...
\mypagestyle
\titleGM
\ednote{Sub title must be filled}
...
\ednote{Remore wikipedia source?}
