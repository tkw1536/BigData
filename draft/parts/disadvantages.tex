...
\ednote{say we are talking about buffering caches}
\ednote{Make sure to explain when switching between local and remote caching}
...
\ednote{A lot more could be written}
